    ...
    if(selectRegion == "모든지역") { //모든지역 선택
      ...
      if(selectMiddleCategory == '0') {
        ...
        if(selectMainCategory == 0) {
          ...
          let sqlQuery = "SELECT GONGUSEQ,MAINGONGUCODE,MAINGONGUNAME,SUBGONGUCODE,SUBGONGUNAME,GONGUNAME,COST,GONGUCOUNT,MAPSEQ,PLACENAME,TELEPHONE,OPENWEEKHOUR,CLOSEWEEKHOUR WHERE `MAINGONGUCODE` = ? ORDER BY `GONGUSEQ`";
